...
const T = {
  mn: {
    ...
    // index.html — Hero
    "hero.h1":
      "Дижитал, дизайн, медиа, вэб хөгжүүлэлт — нэг баг, нэг төлөвлөгөө.",
    "hero.sub":
      "Бид таны төслийг эхнээс нь дуустал нь хөтөлнө: вэб сайт хөгжүүлэлт, интерьер төлөвлөлт, фото/видео үйлдвэрлэл, визийн материал бүрдүүлэлт, мөн барилгын материалын нийлүүлэлт.",
    ...
    "services.p":
      "Карт дээр дарвал тухайн чиглэлийн дэлгэрэнгүй хуудас руу очно.",
    ...
    "card.food.h3": "Хүнс",
    "card.food.p":
      "Импорт, ханган нийлүүлэлт, бөөний болон тогтмол нийлүүлэлт.",
    ...
    "about.p1.p":
      "TB Plan нь олон чиглэлийн нэгдсэн үйлчилгээ үзүүлдэг байгууллага. Бид төслийг зөв төлөвлөөд, хурдан хэрэгжүүлж, хэмжигдэхүйц үр дүн гаргахад төвлөрдөг.",
    ...
    "about.p2.p":
      "Эхлээд хэрэгцээг тодорхойлж, дараа нь төлөвлөгөө + хугацаа + үнэ санал болгоно. Явцын тайлан, загвар/драфт, засваруудыг тодорхой стандарттайгаар хүргүүлдэг.",
    ...
    "slide.web.p":
      "Орчин үеийн, хурдан, найдвартай вэб шийдлүүдийг бизнесийн хэрэгцээнд нийцүүлэн хөгжүүлж байна.",
    ...
    "slide.interior.p":
      "Орон зайн төлөвлөлтөөс дотоод засал чимэглэл, материал, гэрэлтүүлэг, 3D зураглал хүртэл цогц шийдэл.",
    ...
    "slide.media.p":
      "Брэндийн фото/видео, бүтээгдэхүүний зураг авалт, рийл, эвлүүлэг, өнгө засвар.",
    ...
    "slide.visa.p":
      "Олон улсын визний үйл явцыг хялбаршуулж, материал бүрдүүлэлт, шалгалт, маягт бөглөлтөд найдвартай тусална.",
    ...
    "slide.materials.p":
      "Хайрга, Дайрга, Цагаан замаск, Бетон зуурмагны үйлдвэр.",
    "slide.materials.l1": "Бетон, Цагаан замаск",
    "slide.materials.l2": "Хайрга, Дайрга",
    "slide.materials.l3": "Бусад материалууд",
    "slide.food.h2": "Хүнс",
    "slide.food.p":
      "Импорт, ханган нийлүүлэлт, тогтмол нийлүүлэлт — байгууллага болон бөөний хэрэгцээнд.",
    ...
    "contact.sub":
      "Та юу хийх гэж байгаагаа бичээрэй — бид төлөвлөгөөтэйгөөр хариулна.",
    "form.name": "Нэр",
    ...
    "nav.cta": "Үнийн санал",
    "hero.h1.design":
      "Орчин үеийн интерьер — зөв төлөвлөлтөөс бодит гүйцэтгэл хүртэл.",
    "hero.sub.design":
      "TB Plan нь <b>концепт → layout → материал → гэрэлтүүлэг → 3D зураглал → гүйцэтгэл</b> гэсэн нэг шугамаар шийдэж өгнө. Доорх зургууд дээр дарж томоор үзээрэй.",
    ...
    "mini3.body":
      "Талбай (м²) + хэв маяг + төсөв + хугацаа — 4 мэдээлэл байхад хангалттай",
    ...
    "s4.p":
      "Урсгал, суудлын зохион байгуулалт, гэрэлтүүлэг, брэнд мэдрэмжтэй интерьер шийдэл.",
    "s5.h2": "Хүүхдийн өрөө — Төлөвлөлт + тавилгын шийдэл",
    "s5.p":
      "Аюулгүй байдал, хадгалалт, гэрэл, сурах/амрах бүсийг нэгтгэсэн шийдлүүд.",
    "meta.ceiling": "Тааз",
    ...
    "hero.sub.media":
      "Брэндийн фото/видео, бүтээгдэхүүний зураг авалт, рийл, реклам, эвлүүлэг, өнгө засвар, motion зэрэг цогц контент үйлдвэрлэл.",
    ...
    "about.p.media":
      "Доорх үйлчилгээ тус бүр дээр дарвал тухайн хэсэг рүү зөөлөн очно.",
    ...
    "pricing.p.media":
      "Энэ нь суурь үнэ. Ажлын хэмжээ/байршил/өдөр/хүний тооноос шалтгаалж өөрчлөгдөнө.",
    ...
    "note.monthly":
      "<b>Тогтмол хамтын ажиллагаа:</b> сар бүр 8–20 контент үйлдвэрлэх бол багцаар илүү хямд үнээр санал болгоно.",
    ...
    "hero.sub.uilchilgee":
      "Вэб хөгжүүлэлт, медиа үйлдвэрлэл — нэг баг, нэг төлөвлөгөө.",
    ...
    "pricing.web": "🌐 Web хөгжүүлэлт",
    "pricing.app": "📱 Mobile Application",
    "per.month": "сар",
    contract: "Гэрээ",
    month: "сар",
    ...
    "nav.about.u": "Бидний тухай",
    "nav.services.u": "Үйлчилгээ",
    "nav.directions.u": "Чиглэлүүд",
    "nav.details.u": "Дэлгэрэнгүй",
  ...
  zh: {
    ...
    "hero.sub":
      "我们全程陪伴您的项目：网站开发、室内设计、摄影/视频制作、签证材料准备以及建筑材料供应。",
    "hero.btn": "核心服务",
    ...
    "about.p1.h3": "我们做什么？",
    "about.p1.p":
      "TB Plan 是一家提供多领域综合服务的公司。我们专注于精准规划、快速落地，交付可量化的成果。",
    "about.l1": "网站及系统开发",
    ...
    "about.p2.h3": "我们如何工作？",
    "about.p2.p":
      "首先明确需求，然后提供计划 + 时间表 + 报价。以明确的标准交付进度报告、设计稿及修改版本。",
    "pill.research": "调研",
    "pill.plan": "规划",
    "pill.design": "设计",
    "pill.prod": "制作",
    ...
    "slide.interior.p":
      "从空间规划到内部装饰、材料、照明及3D效果图的一体化解决方案。",
    ...
    "slide.visa.h2": "签证咨询",
    "slide.visa.p":
      "简化国际签证流程，提供材料准备、审核及表格填写方面的可靠帮助。",
    ...
    "hero.sub.design":
      "TB Plan 提供 <b>概念 → 布局 → 材料 → 灯光 → 3D渲染 → 施工</b> 一站式服务。点击下方图片可放大查看。",
    "hero.btn1": "室内设计",
    "hero.btn2": "家具设计",
    "hero.btn3": "施工",
    "hero.btn4": "儿童房",
    ...
    "hero.h1.media": "媒体制作",
    "hero.sub.media":
      "品牌摄影/视频、产品拍摄、Reels、广告、剪辑、调色、动态效果等一体化内容制作服务。",
    ...
    "pricing.p.media":
      "以下为基础价格，实际费用因工作量、地点、天数等因素而有所不同。",
    "pc1.h3": "社交媒体图片",
    "pc1.sub": "单件素材",
    "pc1.l1": "单帖 / 单设计",
    "pc1.l2": "社交媒体格式",
    ...
    "badge.popular": "热门",
    "note.monthly":
      "<b>长期合作：</b>每月制作8–20个内容时，可享受套餐优惠价格。",
...
function applyLang() {
  ...
  document.title =
    lang === "zh"
      ? document.title.includes("TB Plan")
        ? document.title.replace(/TB Plan.*/, "TB Plan | 综合服务")
        : document.title
      : document.title;
}
...
if (track && prevBtn && nextBtn && dotsWrap) {
  ...
  sliderSection?.addEventListener("touchstart", () => (isHovering = true), {
    passive: true,
  });
  sliderSection?.addEventListener("touchend", () => (isHovering = false), {
    passive: true,
  });
...
if (lb && shots.length) {
  ...
  function stepLB(dir) {
    openLB((currentLbIndex + dir + shots.length) % shots.length);
  }
