/* ============================================================
   TB Plan — index.js  (Updated: VEX design system)
   Shared JS for all pages · i18n · Loader · Slider · Lightbox
   ============================================================ */
...
const T = {
  mn: {
    ...
    "nav.home":       "нүүр",
    "nav.cta.btn":    "Холбоо барих",
    "back":           "Буцах",

    // Hero — main page
    "hero.h1":   "Дижитал, дизайн, медиа —\nнэг баг, нэг төлөвлөгөө.",
    "hero.sub":  "Бид таны төслийг эхнээс нь дуустал нь хөтөлнө: вэб сайт хөгжүүлэлт, интерьер төлөвлөлт, фото/видео үйлдвэрлэл, барилгын материалын нийлүүлэлт.",
    "hero.btn1": "Чиглэлүүд харах",
    "hero.btn2": "Холбоо барих ↗",
    "hero.tag":  "Дижитал. Дизайн. Медиа.",
    ...
    // Services grid
    "eyebrow.services": "Үндсэн чиглэлүүд",
    "services.h2.a":    "Манай",
    "services.h2.b":    "үйлчилгээнүүд",
    "services.p":       "Карт дээр дарвал тухайн чиглэлийн дэлгэрэнгүй мэдээлэл гарна.",
    ...
    // About
    "eyebrow.about": "Бидний тухай",
    "about.h2":      "TB Plan — ",
    "about.h2.em":   "Бидний тухай",
    ...
    "about.l4":      "Барилгын материалын ханган нийлүүлэлт",
    "about.l5":      "Хүнс — Импорт, бөөн нийлүүлэлт",
    ...
    "step.1":        "Хэрэгцээ тодорхойлох → Судалгаа",
    "step.2":        "Төлөвлөгөө + Үнийн санал",
    "step.3":        "Загвар → Дизайн → Гүйцэтгэл",
    "step.4":        "Тайлан + Засвар → Финал",
    ...
    // Contact
    "eyebrow.contact":      "Холбоо барих",
    "contact.h2.a":         "Ярилцацгаая",
    "contact.h2":           "Холбоо барих",
    "contact.sub":          "Та юу хийх гэж байгаагаа бичээрэй — бид төлөвлөгөөтэйгөөр хариулна.",
    "contact.info.h3":      "TB Plan",
    "contact.info.p":       "Дижитал, дизайн, медиа чиглэлээр таны бизнест нэгдсэн шийдэл санал болгодог баг.",
    "contact.tag.available":"Захиалга авч байна",
    "form.name":    "Нэр",
    "form.contact": "И-мэйл / Утас",
    "form.service": "Үйлчилгээ",
    "form.message": "Мессеж",
    "form.submit":  "Илгээх →",
    ...
    "hero.h1.design":  "Орчин үеийн интерьер —\nзөв төлөвлөлтөөс бодит гүйцэтгэл хүртэл.",
    "hero.sub.design": "Концепт → layout → материал → гэрэлтүүлэг → 3D зураглал → гүйцэтгэл — нэг шугамаар шийдэж өгнө.",
    "hero.btn1":       "Интерьер дизайн",
    "hero.btn2":       "Тавилгын дизайн",
    "hero.btn3":       "Гүйцэтгэл",
    "hero.btn4":       "Хүүхдийн өрөө",
    "hero.tag.design": "Интерьер. Тавилга. Гүйцэтгэл.",
    ...
    "meta.seats":    "Суудал",
    "meta.goal":     "Зорилго",
    "chip.storage":  "Хадгалалт",
    "chip.material": "Материал",
    "chip.detail":   "Деталь",
    "chip.control":  "Хяналт",
    "office.cap1": "Нийт орчны зохион байгуулалт",
    "office.cap2": "Танхим / презентацийн хэсэг",
    "office.cap3": "Амралтын / coffee булан",
    "office.cap4": "Ажлын ширээний кластер",
    "office.cap5": "Тавиур + хадгалалтын шийдэл",
    "furn.cap1": "Шүүгээний фасад + муруй тавиур",
    "furn.cap2": "Өрөөний layout / 3D",
    "furn.cap3": "Ор + ажлын ширээний интеграц",
    "furn.cap4": "Деталь + хадгалалтын шийдэл",
    "exec.cap1": "Ерөнхий харагдац / талбайн шийдэл",
    "exec.cap2": "Зохион байгуулалт / интерьер булан",
    "exec.cap3": "Деталь / материалын мэдрэмж",
    "exec.cap4": "Талбайн шийдэл / өндөр зай",
    "exec.cap5": "Гүйцэтгэлийн явц",
    "exec.cap6": "Материалын уялдаа",
    "exec.cap7": "Тавилга / угсралтын деталь",
    "exec.cap8": "Финал харагдац",
    "cafe.cap1": "Ерөнхий орчин / суудлын бүс",
    "cafe.cap2": "Бар / кассын уялдаа",
    "cafe.cap3": "Акцент гэрэл + материал",
    "cafe.cap4": "Деталь / close-up",
    "cafe.cap5": "Нэмэлт өнцөг",
    "child.cap1": "Ерөнхий төлөвлөлт",
    "child.cap2": "Сурах ширээ + гэрэлтүүлэг",
    "child.cap3": "Шүүгээ / хадгалалт",
    "child.cap4": "Деталь",
    ...
    "hero.btn1.media":     "Үнийн санал харах",
    "hero.btn2.media":     "Жишээ ажил",
    "hero.tag.media":      "Фото. Видео. Motion. Рийл.",
    "meta.format.title":   "Контент хэлбэр",
    "meta.pkg.title":      "Багц",
    "meta.pkg.note":       "Тогтмол хамтын ажиллагаа боломжтой",
    "about.h2.media":      "Юу хийдэг вэ?",
    "about.p.media":       "Доорх үйлчилгээ тус бүр дэлгэрэнгүй мэдээлэлтэй.",
    "chip.photo":          "Фото зураг авалт",
    "chip.video":          "Видео зураг авалт",
    "chip.edit":           "Эвлүүлэг & Өнгө засвар",
    "chip.examples":       "Жишээ ажил",
    "chip.price":          "Үнэ",
    ...
    "svc.edit.l1":         "Cut / pacing / subtitle",
    "svc.edit.l2":         "Color grading",
    ...
    "examples.p":          "Манай бүтээсэн контент, фото, видео ажлуудаас.",
    "examples.photos":     "Зураг",
    "examples.videos":     "Бичлэгүүд",
    "gcard.1":             "Брендийн фото зураг авалт",
    "gcard.2":             "Бүтээгдэхүүний зураг (e-commerce)",
    "gcard.3":             "Бүтээгдэхүүний зураг (e-commerce)",
    "gcard.4":             "Reels / short-form контент",
    "vhint":               "Tap to open",
    ...
    "pc1.h3":  "Social Media Graphic",
    "pc1.sub": "Single Asset",
    "pc1.l1":  "Нэг пост / нэг дизайн",
    "pc1.l2":  "Сошиал формат",
    "pc1.l3":  "Үнэ нь төвөгшлөөс хамаарна",
    "pc2.h3":  "Short Video",
    "pc2.sub": "60 sec or less",
    "pc2.l1":  "Видео эвлүүлэг",
    "pc2.l2":  "Motion graphics",
    "pc2.l3":  "Reels / Shorts формат",
    "pc3.h3":  "Full Production Video",
    "pc3.sub": "Story + shooting + full edit",
    "pc3.l1":  "Сценар / Storyboard",
    "pc3.l2":  "Зураг авалт",
    "pc3.l3":  "Бүрэн эвлүүлэг + өнгө засвар",
    "pc4.h3":  "Video Editing",
    "pc4.sub": "Without shooting",
    "pc4.l1":  "Зөвхөн эвлүүлэг",
    "pc4.l2":  "Color grading",
    "pc4.l3":  "Motion / subtitle",
    "btn.order":     "Захиалах",
    ...
    "footer.home.media":   "← Нүүр хуудас",

    // Services/pricing page
    "hero.h1.uilchilgee":  "Вэб хөгжүүлэлт, медиа үйлдвэрлэл —\nнэг баг, нэг төлөвлөгөө.",
    "hero.sub.uilchilgee": "Вэб хөгжүүлэлт, медиа үйлдвэрлэл — нэг баг, нэг төлөвлөгөө. Доороос үнийн саналтай танилцана уу.",
    "hero.btn.uilchilgee": "Үйлчилгээ үзэх",
    "hero.eyebrow.u":      "TB PLAN — ҮЙЛЧИЛГЭЭ",
    "stat.services":       "Үндсэн үйлчилгээ",
    "stat.onestop.u":      "Нэг цэгийн шийдэл",
    "stat.fast.num":       "Шуурхай",
    "stat.fast.label":     "Төлөвлөлт → Гүйцэтгэл",
    "section.h2":          "Манай үйлчилгээ",
    "section.p":           "Чиглэл бүр дэлгэрэнгүй мэдээлэл, үнийн саналтай.",
    "svc.web.h3":          "🌐 Вэб хөгжүүлэлт",
    "svc.web.p":           "Вэб сайт, лендинг, систем, админ самбар.",
    "svc.web.l1":          "SEO + Analytics суурь",
    "svc.web.l2":          "Form + Захиалга / мессеж",
    "svc.web.l3":          "Admin систем / CRM",
    "svc.media.h3":        "🎬 Медиа продакшн",
    "svc.media.p":         "Рийл, реклам, фото / видео эвлүүлэг.",
    "svc.media.l1":        "Контент төлөвлөгөө",
    "svc.media.l2":        "Видео эвлүүлэг + color",
    "svc.media.l3":        "Брэнд визуал дизайн",
    "card.link.u":         "Үнэ харах →",
    "pricing.h2.u":        "Үнийн санал",
    "pricing.web":         "🌐 Вэб хөгжүүлэлт",
    "pricing.app":         "📱 Mobile App",
    "per.month": "сар",
    "contract":  "Гэрээ",
    "month":     "сар",
    "wstart.l1": "1–5 хуудастай вэб сайт",
    "wstart.l2": "Mobile & desktop",
    "wstart.l3": "Бэлэн загвар",
    "wstart.l4": "Контент (1–2/сар)",
    "wstart.l5": "Domain + hosting",
    "wstart.l6": "Суурь аюулгүй байдал",
    "wstart.l7": "📌 Гэрээ: 6–12 сар",
    "wstd.l1":   "5–10 хуудас",
    "wstd.l2":   "Custom дизайн",
    "wstd.l3":   "Контент (4/сар)",
    "wstd.l4":   "SEO суурь",
    "wstd.l5":   "Хурдны оптимизаци",
    "wstd.l6":   "Form / захиалга",
    "wstd.l7":   "📌 Гэрээ: 12 сар",
    "wbiz.l1":   "10+ хуудас / dynamic",
    "wbiz.l2":   "Admin panel",
    "wbiz.l3":   "Захиалга, мессеж",
    "wbiz.l4":   "SEO + Google index",
    "wbiz.l5":   "Backup + security",
    "wbiz.l6":   "Priority support",
    "wbiz.l7":   "📌 Гэрээ: 12 сар",
    "mvp.l1":    "Android эсвэл iOS",
    "mvp.l2":    "Энгийн UI/UX",
    "mvp.l3":    "Контент удирдлага",
    "mvp.l4":    "Store байршуулалт",
    "mvp.l5":    "📌 Гэрээ: 12 сар",
    "bapp.l1":   "Android + iOS",
    "bapp.l2":   "Admin систем",
    "bapp.l3":   "Push notification",
    "bapp.l4":   "Security + backup",
    "bapp.l5":   "📌 Гэрээ: 12–18 сар",

    // web.html
    "term.file":  "терминал — tb-plan",
    "term.title": "Бодит код, бодит гүйцэтгэл",
    "svc.h3":     "// үйлчилгээ",
    "svc.sub":    "Таны бизнесийн хэрэгцээнд нийцэх вэб шийдэл бүтээнэ.",
    ...
    "cta.h3":     "Төслөө эхлүүлэхэд бэлэн үү?",
    "cta.p":      "Хэрэгцээ, хугацаа, төсвөө бичиж илгээгээрэй — бид хариулна.",
    "cta.btn":    "Холбоо барих →",
    "footer.web": "© 2026 TB Plan — бэлэн загвар биш, цэвэр код.",
    "nav.web.services": "// үйлчилгээ",
    "nav.web.stack":    "// стек",
    "nav.web.contact":  "// холбоо барих",
    "nav.web.cta":      "Захиалах",
    "hero.h1.web":      "Вэб хөгжүүлэлт —\nцэвэр код, бодит гүйцэтгэл.",
    "hero.sub.web":     "Өндөр гүйцэтгэлтэй, сайтар бодогдсон вэб шийдлүүд — таны бизнесийн хэрэгцээнд нийцүүлэн.",
    "hero.btn1.web":    "Захиалах",
    "hero.btn2.web":    "Үйлчилгээ үзэх",

    // Shared form options (no visa)
    serviceOptions: [
      "Вэб хөгжүүлэлт",
      "Интерьер дизайн",
      "Медиа продакшн",
    ...
    formSuccess: (n, s) =>
      `Баярлалаа, ${n}! "${s}" үйлчилгээний хүсэлтийг хүлээн авлаа. Бид эргэн холбогдоно.`,

    // Role cycling (hero)
    roles: ["бизнес", "алсын харааг", "брэнд", "контент"],
  ...
  zh: {
    ...
    "hero.h1":   "数字、设计、媒体 —\n一支团队，一个方案。",
    "hero.sub":  "我们全程陪伴您的项目：网站开发、室内设计、摄影/视频制作以及建筑材料供应。",
    "hero.btn1": "查看服务",
    "hero.btn2": "联系我们 ↗",
    "hero.tag":  "数字. 设计. 媒体.",
    ...
    "contact.info.h3":      "TB Plan",
    "contact.info.p":       "为您的企业提供数字、设计、媒体综合解决方案的团队。",
    "contact.tag.available":"正在接受预约",
    "form.name":    "姓名",
    "form.contact": "邮箱 / 电话",
    "form.service": "服务类型",
    "form.message": "留言",
    ...
    "hero.h1.design":  "现代室内设计 —\n从规划到完美施工。",
    "hero.sub.design": "概念 → 布局 → 材料 → 灯光 → 3D渲染 → 施工 — 一站式服务。",
    "hero.btn1":       "室内设计",
    "hero.btn2":       "家具设计",
    "hero.btn3":       "施工",
    "hero.btn4":       "儿童房",
    "hero.tag.design": "室内设计. 家具. 施工.",
    "brandSub":        "Plan • 室内设计",
    "nav.interior":    "室内设计",
    "nav.furniture":   "家具",
    "nav.execution":   "施工",
    ...
    "hero.btn1.media":     "查看报价",
    "hero.btn2.media":     "作品案例",
    "hero.tag.media":      "摄影. 视频. Motion. Reels.",
    "meta.format.title":   "内容形式",
    "meta.pkg.title":      "套餐",
    "meta.pkg.note":       "支持长期合作",
    "about.h2.media":      "我们提供什么？",
    "about.p.media":       "点击下方服务类别可查看详细信息。",
    "chip.photo":          "摄影",
    "chip.video":          "视频拍摄",
    "chip.edit":           "剪辑与调色",
    "chip.examples":       "作品案例",
    ...
    "hero.h1.uilchilgee":  "网站开发、媒体制作 —\n一支团队，一个方案。",
    "hero.sub.uilchilgee": "网站开发、媒体制作 — 一支团队，一个方案。请查看以下报价。",
    "hero.btn.uilchilgee": "查看服务",
    "hero.eyebrow.u":      "TB PLAN — 服务",
    "stat.services":       "核心服务",
    "stat.onestop.u":      "一站式解决方案",
    "stat.fast.num":       "高效",
    "stat.fast.label":     "规划 → 执行",
    "section.h2":          "我们的服务",
    "section.p":           "每个服务方向均有详细信息和报价。",
    "svc.web.h3":          "🌐 网站开发",
    "svc.web.p":           "网站、落地页、系统、管理后台。",
    "svc.web.l1":          "SEO + Analytics基础配置",
    "svc.web.l2":          "表单 + 订单/消息",
    "svc.web.l3":          "管理系统 / CRM",
    "svc.media.h3":        "🎬 媒体制作",
    "svc.media.p":         "Reels、广告、图片/视频剪辑。",
    "svc.media.l1":        "内容规划",
    "svc.media.l2":        "视频剪辑 + 调色",
    "svc.media.l3":        "品牌视觉设计",
    "card.link.u":         "查看价格 →",
    "pricing.h2.u":        "报价方案",
    "pricing.web":         "🌐 网站开发",
    ...
    "wbiz.l2":   "管理后台",
    "wbiz.l3":   "订单、消息系统",
    "wbiz.l4":   "SEO + Google索引",
    "wbiz.l5":   "备份 + 安全",
    "wbiz.l6":   "优先技术支持",
    "wbiz.l7":   "📌 合同期：12个月",
    "mvp.l1":    "Android 或 iOS",
    "mvp.l2":    "简洁UI/UX",
    "mvp.l3":    "内容管理",
    "mvp.l4":    "应用商店上架",
    "mvp.l5":    "📌 合同期：12个月",
    ...
    "term.title": "真实代码，真实交付",
    "svc.h3":     "// 服务项目",
    "svc.sub":    "为您的业务构建合适的网站解决方案。",
    "svc.l1":     "高性能企业网站",
    "svc.l2":     "以销售为导向的落地页",
    "svc.l3":     "管理后台、CRM系统",
    "svc.l4":     "电商平台",
    ...
    "stack.h3":   "// 技术栈",
    "cta.h3":     "准备好启动项目了吗？",
    "cta.p":      "告诉我们您的需求、时间表和预算，我们会及时回复。",
    "cta.btn":    "联系我们 →",
    "footer.web": "© 2026 TB Plan — 纯代码，非模板。",
    "nav.web.services": "// 服务",
    "nav.web.stack":    "// 技术栈",
    "nav.web.contact":  "// 联系我们",
    "nav.web.cta":      "立即预约",
    "hero.h1.web":      "网站开发 —\n纯代码，真性能。",
    "hero.sub.web":     "为您的业务量身打造高性能、精心设计的网站解决方案。",
    "hero.btn1.web":    "立即预约",
    "hero.btn2.web":    "查看服务",
...
function applyLang() {
  ...
  // Rebuild hero heading if present
  const h1Elem = document.getElementById("heroH1") || document.getElementById("heroHeading");
  if (h1Elem) {
    const heroKey = h1Elem.getAttribute("data-hero-key") || "hero.h1";
    const rawText = d[heroKey];
    if (rawText) buildHeading(rawText, h1Elem.id);
  }

  // Restart terminal if present
...
if (cursorEl) {
  ...
  document.querySelectorAll("a, button, .bcard, .sdot, .shot, .svc-card, .p-card, .stack-item, .vcard, .gcard").forEach((el) => {
...
(function initLoader() {
  ...
  if (!loader) return;
  const words   = ["Design", "Build", "Create", "Inspire"];
  ...
  const wt = setInterval(() => {
    ...
    setTimeout(() => {
      ...
      wordEl.style.transition = "opacity .35s ease, transform .35s ease";
    }, 180);
  }, 900);
  const iv = setInterval(() => {
    count += Math.random() < .3 ? 3 : Math.random() < .6 ? 2 : 1;
...
function buildHeading(text, targetId) {
  const id = targetId || "heroH1";
  ...
  lines.forEach((line, li) => {
    ...
    line.split("").forEach((ch, ci) => {
      ...
      s.className = "char";
      s.textContent = ch === " " ? "\u00A0" : ch;
      const delay = INIT_DELAY + (li * ll * CHAR_DELAY) + (ci * CHAR_DELAY);
      setTimeout(() => s.classList.add("v"), delay);
      el.appendChild(s);
    });
...
function fadeIn(id, delay) {
  setTimeout(() => document.getElementById(id)?.classList.add("fi"), delay);
}

// ============================================================
// Role cycling (hero subtitle)
// ============================================================
...
window.addEventListener("scroll", () => {
  navPill?.classList.toggle("sc", scrollY > 60);
  topbar?.classList.toggle("is-scrolled", scrollY > 20);
}, { passive: true });

// ============================================================
// Mobile nav toggle (legacy topbar)
// ============================================================
...
// ============================================================
// Card background images (legacy .card[data-img])
// ============================================================
...
// Detail slide backgrounds (legacy)
document.querySelectorAll(".detail[data-bg]").forEach((sec) => {
...
contactForm?.addEventListener("submit", (e) => {
  ...
  if (formHint) {
    ...
    formHint.classList.add("show", "is-visible");
  }
  contactForm.reset();
  setTimeout(() => {
    formHint?.classList.remove("show", "is-visible");
  }, 6500);
});

// ============================================================
// Detail Slider (legacy — uses .sliderDot / .sliderBtn)
// ============================================================
(function initDetailSlider() {
  ...
  if (dotsWrap) {
    ...
    slides.forEach((_, i) => {
      ...
      d.className = (i === 0 ? "sliderDot is-active" : "sliderDot") + " sdot" + (i === 0 ? " is-active" : "");
      d.setAttribute("aria-label", `${i + 1}-р слайд`);
      d.addEventListener("click", () => { goTo(i, true); startAutoplay(); });
  ...
  function restartKenBurns() {
    ...
    slides[index].classList.add("kb-restart");
  }
  function goTo(i, smoothScroll = false) {
    ...
    restartKenBurns();
    // Apply slide-bg KB on new slider
    slides.forEach((s, si) => {
      const bg = s.querySelector(".slide-bg");
      if (bg) bg.style.transform = si === index ? "scale(1.13)" : "scale(1.06)";
    });
    if (smoothScroll) document.getElementById("details")?.scrollIntoView({ behavior: "smooth" });
  }
  ...
  function startAutoplay() {
    stopAutoplay();
    autoplayTimer = setInterval(() => { if (!isHovering) goTo(index + 1); }, 5500);
  }
  ...
  function hashToSlide() {
    ...
    if (!h) return;
    const ti = slides.findIndex((s) => s.id === h);
    if (ti >= 0) goTo(ti);
  }
  window.addEventListener("hashchange", hashToSlide);

  // Service bento card → slider
  document.querySelectorAll(".bcard[href^='#']").forEach((a) => {
    a.addEventListener("click", (e) => {
      const hash = a.getAttribute("href");
      if (!hash) return;
      const ti = slides.findIndex((s) => s.id === hash.replace("#", ""));
      if (ti >= 0) { e.preventDefault(); goTo(ti, true); }
    });
  });
...
// ============================================================
// Bullet click → subpages (legacy)
// ============================================================
document.querySelectorAll("#web .detail__bullets li").forEach((li) => {
  li.style.cursor = "pointer";
  li.addEventListener("click", (e) => { e.preventDefault(); e.stopPropagation(); window.location.href = "web.html"; });
});
document.querySelectorAll("#interior .detail__bullets li").forEach((li) => {
  li.style.cursor = "pointer";
  li.addEventListener("click", (e) => { e.preventDefault(); e.stopPropagation(); window.location.href = "design.html"; });
});
...
if (modal && modalVideo) {
  ...
  const io = new IntersectionObserver((entries) => {
    ...
    if (visible?.target) {
      pauseAllInline(visible.target);
      visible.target.muted = true;
      visible.target.play()?.catch(() => {});
    } else pauseAllInline(null);
  ...
  function openModal(src) {
    ...
    modalVideo.src = src; modalVideo.currentTime = 0; modalVideo.muted = false;
  ...
  document.querySelectorAll(".vFrame[data-modal-src], .vcard[data-src]").forEach((frame) => {
    const src = frame.getAttribute("data-modal-src") || frame.getAttribute("data-src");
    frame.addEventListener("click", () => { if (src) openModal(src); });
  });
}

// ============================================================
// Lightbox (design.html gallery)
// ============================================================
(function initLightbox() {
  ...
  function openLB(i) {
    cur = i;
    const s = shots[i];
    if (lbImg) { lbImg.src = s.querySelector("img")?.src || ""; }
    if (lbTitle) lbTitle.textContent = s.getAttribute(`data-title-${lang}`) || s.getAttribute("data-title") || "";
    lb.classList.add("is-open", "open");
    document.body.style.overflow = "hidden";
  }
  function closeLB() {
    lb.classList.remove("is-open", "open");
    document.body.style.overflow = "";
  }
  function stepLB(dir) { openLB((cur + dir + shots.length) % shots.length); }
...
// ============================================================
// Pricing tab switcher (uilchilgee.html)
// ============================================================
...
// Hero fade-ins
fadeIn("heroSub",   800);
fadeIn("heroBtns", 1200);
fadeIn("heroTag",  1400);
fadeIn("heroPills", 1000);
